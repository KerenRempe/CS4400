...
class poop:
    ...
    def sum12(self):
        ...
        if self.spring2014.get()==1 and self.summer2014.get()==0 and self.fall2014.get()==0:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)","Spring 2014")
        if self.summer2014.get()==2 and self.spring2014.get()==0 and self.fall2014.get()==0:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)","Summer 2014")
        if self.fall2014.get()==3 and self.spring2014.get()==0 and self.summer2014.get()==0:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)","Fall 2014")
        if self.spring2014.get()==1 and self.summer2014.get()==2 and self.fall2014.get()==0:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s), (%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)",("Spring 2014", "Summer 2014"))
        if self.spring2014.get()==1 and self.summer2014.get()==0 and self.fall2014.get()==3:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s), (%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)",("Spring 2014", "Fall 2014"))
        if self.spring2014.get()==0 and self.summer2014.get()==2 and self.fall2014.get()==3:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s), (%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)",("Summer 2014", "Fall 2014"))
        if self.spring2014.get()==1 and self.summer2014.get()==2 and self.fall2014.get()==3:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL,CHOOSES.COURSE_NUM) AS Course, SEMESTER, COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES  WHERE SEMESTER IN ((%s), (%s), (%s))  GROUP BY COURSE, SEMESTER WITH ROLLUP)",("Spring 2014","Summer 2014", "Fall 2014"))
...
#            print("this didn't work...")
    ...
    def sum22(self):
        ...
        if self.spring.get()==1 and self.summer.get()==0 and self.fall.get()==0:
            b=c.execute("CREATE VIEW Admin_Report1 AS (SELECT CONCAT(CHOOSES.SCHOOL, ' ', CHOOSES.COURSE_NUM) AS COURSE, IFNULL(SEMESTER, 'TOTAL'), COUNT(DISTINCT CHOOSES.UGRAD_GTID) AS Num_Students, COUNT(DISTINCT CHOOSES.TUT_GTID) AS Num_Tutors FROM CHOOSES WHERE SEMESTER IN ((%s))  GROUP BY CONCAT(SCHOOL,COURSE_NUM), SEMESTER ORDER BY SCHOOL, COURSE_NUM, SEMESTER)","Spring 2014")
